...
public class TestCase {
    ...
    public List<String> getAllTestCaseNames() throws IOException, APIException {
        ...
        List<JSONObject> c = (List<JSONObject>) client.sendGet("get_cases/"+testProjects.getAllProjects(Constants.TEST_RAIL_PROJECT_NAME.value)+"&suite_id="+testSuite.getTestSuiteId(Constants.TEST_RAIL_PROJECT_NAME.value, Constants.TEST_RAIL_SUITE_NAME.value)+"");
        for (JSONObject jsonObject : c) {
